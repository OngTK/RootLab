...
<div id="container">
    ...
    <header>
        <div class="logoHeader">
            ...
            <a href="/html/admin/member/index.html" class="logo"><strong>Root.Lab</strong><span>테마형 관광지도 플랫폼</span></a>
        </div>
        <div class="gnb">
            ...
            <nav>
                <ul>
                    <li><a href="/html/admin/plan/index.html">구독플랜관리</a></li>
                    <li><a href="/html/admin/subscription/index.html">구독관리</a></li>
                    <li class="active"><a href="/html/admin/member/index.html">회원관리</a></li>
                    <li><a href="/html/admin/siteInfo/index.html">사이트관리</a></li>
                    <li><a href="/html/admin/mapData/index.html">지도데이터관리</a></li>
                </ul>
            </nav>
            <ul class="memberMenu">
