...
export const pageTitle = () => {
    ...
    const { menu1Depth, menu2Depth, pathUrl1, pathUrl2 } = map_info();
    ...
    const pageTitleHTML = `   
        ...
        <div class="pageTitle">
            <h1>
                ...
                <span>${menu2Depth}</span>
            </h1>
            <span class="path">
                <a href="${pathUrl1}">${menu1Depth}</a>
                <a href="${pathUrl2}">${menu2Depth}</a>
            </span>
        </div>
        <!-- 페이지 타이틀 끝 -->
    `
    mainHTML.insertAdjacentHTML('afterbegin', pageTitleHTML);
 }//func end
