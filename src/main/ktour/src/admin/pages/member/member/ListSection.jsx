...
export default function ListSection(props) {
    ...
    const columns = [
        ...
        { id: "mType", title: "회원유형", width: 110 },
        { id: "mName", title: "회원명", width: 120 },
        { id: "mNick", title: "닉네임", width: 120 },
        { id: "mId", title: "회원ID", width: 140 },
        { id: "mGender", title: "성별", width: 140 },
        { id: "mPhone", title: "휴대전화", width: 200 },
        { id: "createdAt", title: "가입일", width: 120 },
        { id: "updatedAt", title: "최종로그인", width: 120 },
    ];

    const data = [
        { no: 1, mType: "일반회원", mName: "김진숙", mNick: "시스템관리자", mId: "admin", mGender: "여성", mPhone: "010-2345-6789", createdAt: "2025-10-27 18:42", updatedAt: "2025-10-27 18:42" }
    ];
                ...
                <div className="detailSearch">
                    <form aria-label="회원현황 조건검색">
                        ...
                        <span className="form-group">
                            <label htmlFor="mgAuth">회원유형</label>
                        ...
                        {/* 2.회원명 */}
                        <span className="form-group">
                            <label htmlFor="mName">회원명</label>
                            <input type="text" id="mName" name="mName" />
                        </span>
                        {/* 3.회원ID */}
                        <span className="form-group">
                            <label htmlFor="mId">회원ID</label>
