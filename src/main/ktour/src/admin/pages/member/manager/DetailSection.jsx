...
import UpdatePwd from "@admin/pages/member/manager/UpdatePwd"; // 비밀번호 수정 > 버튼/레이어 컴포넌트
import ResetPwd from "@admin/pages/member/manager/ResetPwd";  // 비밀번호 초기화 > 버튼/레이어 컴포넌트
            ...
            <section className="registWrap">
                ...
                <div className="titleBox">
                    <ul className="tabtitle">
                        <li className="active">관리자 기본정보</li>
                    </ul>
